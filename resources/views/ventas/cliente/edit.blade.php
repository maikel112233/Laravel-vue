...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Modificar cliente <span class="text-success">{{$persona->nombre}}</span></h4>
                <hr>
                <div class="col-lg-6 col-md-6 col-xs-12">
                    ...
                    @endif 
                    {!!Form::model($persona,['route'=>['cliente.update',
                    ...
                    <div class = "form-group">
                        <a href="{!!URL::to('ventas/cliente/')!!}" class="btn btn-danger">Cancelar</a>
